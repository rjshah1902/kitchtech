...
const NursingHomeResidentsList: React.FC<FoodItemListProps> = ({ foodItem, deleteItem }) => {
                                ...
                                <div className="overflow-hidden border border-gray-200 md:rounded-lg">
                                    <table className="min-w-full divide-y divide-gray-200">
                                        ...
                                        <tbody className="divide-y divide-gray-200 bg-white">
                                            {foodItem.map((data: { id: string, name: string, food_type: string, terminology_name: string }, index) => (
                                                <tr key={index} className="divide-x divide-gray-200">
                                                    ...
                                                    <td className="whitespace-nowrap px-4 py-4 text-right text-sm font-medium">
                                                        <Link to={`/home-residents/${data.id}`} className="bg-yellow-600 px-4 py-2 text-white rounded-md">
                                                            Edit
                                                        </Link>
...
export default NursingHomeResidentsList;
